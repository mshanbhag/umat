...
public class StartUI extends JFrame 
{
	...
	public void SubscribeForSingleScrip()
	{
	    ...
	    if(sToken == null || sExc == null || sToken.equals("")|| sExc.equals(""))
	    {
	...
	public void FrameInit()
	{
		...
		try
		{
			...
			jbUnsubscribeFile.addActionListener(new ActionListener()
					{
						...
						public void actionPerformed(ActionEvent e) 
						{
			        		...
			        		try 
			        		{
			        	        BufferedReader in = new BufferedReader(new FileReader(file2));
			        	        	 ...
			        	        	 String s_nse_file_data ="";   		
			        	    		    ...
			        	    		    if(oScripVec.size() != 0 && Exc != null )
			        	    		    {
			        	    		    	...
			        	    		    	handl.sentRequestToServerUnSubscribe(NESTconstants.UN_SUB_ALL_GIVEN_TOKENS, Exc, oScripVec);
			        		   ...
			        		   {
			        		   	System.out.println("Error :: ==> Error file not found :: ==>" +e32);
			        		   }	
			...
			jbSubscribeFile.addActionListener(new ActionListener()
			{
	        	        ...
	        	        BufferedReader in = new BufferedReader(new FileReader(file1));
	        	        	 ...
	        	        	 String s_nse_file_data ="";   		
	        	    		    ...
	        	    		    if(oScripVec.size() != 0 && Exc != null )
	        	    		    {
	        	    		    	...
	        	    		    	handl.sentRequestToServerSubscribe(NESTconstants.SUB_ALL_GIVEN_TOKENS, Exc, oScripVec);
