...
public class CNESTBhavCopy
{
	

    public int        iTransCode  = -1;   //value 1006
    ...
    public long     lPrevClosingPrice= 0;      //MNM_CLOSE_PRICE

    public long     lYearlyLowPrice= 0;     

    public long     lYearlyHighPrice= 0;
    public long     lHighestOpenInterest= 0; //MNM_YEARLY_HIGH_OPEN_INTEREST

    public long     lLowestOpenInterest= 0; //MNM_YEARLY_LOW_OPEN_INTEREST
