...
/**
 * class illustrating IP Multicast by receiving simple text messages via IP
 * Multicast; use IPMulticastSender to send the messages.
 * 
...
public class HandleConnection {
    ...
    private static Vector<?> oMktPic = new Vector<Object>();
    ...
    // count to check the received packets

    private static ObjectInputStream input_stream = null;
    private static ObjectOutputStream out_stream = null;

    private static Vector<String> vec_nse_cm = new Vector<String>();
    private static Vector<String> vec_bse_cm = new Vector<String>();
    private static Vector<String> vec_nse_fo = new Vector<String>();
    private static Vector<String> vec_mcx = new Vector<String>();
    private static Vector<String> vec_ncdex = new Vector<String>();
    private static Vector<String> vec_cds = new Vector<String>();
    ...
    public static void PutSubscription() {
        try {
            ResourceBundle oResourceBundle = ResourceBundle.getBundle(
                    "UDPConfig");

            if (oResourceBundle.getString("SUBSCRIBE").trim().equals("YES")) {
                // System.out.print("Testing :--"+oResourceBundle.getString("SUBSCRIBE"));
                ...
                i_port = Integer.parseInt(
                        oResourceBundle.getString("host_port").toString().trim());
                ...
                System.out.println(
                        "*                                                    *");
                System.out.println(
                        "      Welcome to Market Feed Data Application ");
                System.out.println(
                        "*     Omnesys Technologies Pvt. Ltd., Bangalore      *");
                System.out.println(
                        "*     Version : 1.7.0.0                              *");
                System.out.println(
                        "*                                                    *");
                ...
                System.out.println(
                        "******************************************************");
                System.out.println(
                        "Success -> " + i_port + " : Port has been Locked");
                System.out.println(" ");
                ...
                System.out.println(
                        "b_nse_file_read ========> " + b_nse_file_read);
                // System.out.println( "b_bse_file_read ========> "
                // +b_bse_file_read);
                // System.out.println( "b_nfo_file_read ========> "
                // +b_nfo_file_read);
                // System.out.println("b_cds_file_read ===========>"
                // +b_cds_file_read);
                ...
                if (b_nse_file_read == true || b_nse_file_read == true
                        || b_nfo_file_read == true || b_mcx_file_read == true
                        || b_ncdex_file_read == true || b_cds_file_read == true) {
                    ...
                    SharedResources.WriteToLog(
                            "|-------------------------------------------------------------------------|");
                    SharedResources.WriteToLog(
                            "Process Connected to Streamer Server With user Id  :: ====>"
                                    + s_UserName);
                    SharedResources.WriteToLog(
                            "Process Connected to Streamer Server IP 		   :: ====>"
                                    + host_ip);
                    SharedResources.WriteToLog(
                            "Process Connected to Streamer Server Port		   :: ====>"
                                    + i_port);
                    SharedResources.WriteToLog(
                            "Connected .........................");
                    ...
                    System.out.println(
                            "Error :: ==> Token files missing file names(NSE_FO_INPUT.txt | NSE_FO_INPUT.txt | BSE_EQ_INPUT.txt ) ");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println(
                    "Error :: ==> Critical -> Selected Port is Busy , Can't Continue on Port : "
                            + e);
    ...
    public HandleConnection() {
        ...
        try {
            ...
            System.out.println(
                    "Missing Resource BUFFER_SIZE ------ Defaulted to 2MB ---- "
                            + ex.toString());
        }
        receiveBuffer = new byte[BUFFER_SIZE];
        MULTICAST_ADDRESS = oResourceBundle.getString("MULTI_CAST_ADRESS").trim();
        MULTICAST_PORT = Integer.parseInt(
                oResourceBundle.getString("MULTICAST_PORT").trim());
        ...
        System.out.println(
                "*                                                    *");
        System.out.println(
                "      Welcome to Market Feed UDP Reciever Application ");
        System.out.println(
                "*     Omnesys Technologies Pvt. Ltd., Bangalore      *");
        System.out.println(
                "*     Version : 1.7.0.0                             *");
        ...
        try {
            ...
            System.out.println(
                    "Exception in creating Socket or Packet: " + e.toString());
            e.printStackTrace();
        }
    }
    ...
    private void writeDataToFile() {
        ...
        try {
            IndexInfoFile = new BufferedWriter(
                    new FileWriter(s_Index_output_file_name));
    ...
    public void WriteBhavCopyFile() {
        ...
        try {
            BhavCpFile = new BufferedWriter(
                    new FileWriter(s_bhavcopy_output_file_name));
            ...
            /*
             * sb.append("sRecordBuffer"); sb.append(",");
             */
    ...
    public void writeMKTPicFile() {
        ...
        try {
            MktPicFile = new BufferedWriter(
                    new FileWriter(s_mktpic_output_file_name));
            StringBuffer sb = new StringBuffer();
    ...
    private void WriteNewsLog() {
        ...
        try {
            ...
            NewsInfoFile = new BufferedWriter(
                    new FileWriter(s_New_output_file_name));
            StringBuffer sb = new StringBuffer();
    ...
    private void WriteDJNewsLog() {
        ...
        try {
            ...
            DJNewsFile = new BufferedWriter(
                    new FileWriter(s_DJNews_output_file_name));
            StringBuffer sb = new StringBuffer();
    ...
    private void receiveMessage() {
        try {
            ...
            case NESTconstants.NEST_MKTPIC:
                ...
                try {
                    System.out.println(
                            "NestMktPiccb.iTransCode---------------------->"
                                    + CNestMktData.iTransCode);
                    System.out.println(
                            "CNestMktData.sExchSeg------------------------->"
                                    + CNestMktData.sExchSeg);
                    System.out.println(
                            "CNestMktData.sSymbol-------------------------->"
                                    + CNestMktData.sSymbol);
                    System.out.println(
                            "CNestMktData.siMarketType--------------------->"
                                    + CNestMktData.siMarketType);
                    System.out.println(
                            "CNestMktData.lVolumeTradedToday--------------->"
                                    + CNestMktData.lVolumeTradedToday);
                    System.out.println(
                            "CNestMktData.lLastTradedPrice----------------->"
                                    + CNestMktData.lLastTradedPrice);

                    /*
                     * System.out.println(
                     * "CNestMktData.sNetChangeIndicator-------------->"
                     * +CNestMktData.sNetChangeIndicator); System.out.println(
                     * "CNestMktData.lNetPriceChangeFromClosingPrice-->"
                     * +CNestMktData.lNetPriceChangeFromClosingPrice);
                     * System.out
                     * .println("CNestMktData.lLastTradeQuantity--------------->"
                     * +CNestMktData.lLastTradeQuantity); System.out.println(
                     * "CNestMktData.lLastTradeTime-------------------->"
                     * +CNestMktData.lLastTradeTime); System.out.println(
                     * "CNestMktData.lAverageTradePrice---------------->"
                     * +CNestMktData.lAverageTradePrice);
                     * 
                     * System.out.println(
                     * "CNestMktData.lNoofTrades----------------------->"
                     * +CNestMktData.lNoofTrades);
                     * //System.out.println("++++++++++++++++++=");
                     * 
                     * System.out.println(
                     * "CNestMktData.siAuctionNumber-------------------->"
                     * +CNestMktData.siAuctionNumber); //System.out.println(
                     * "CNestMktData.sRecordBuffer--------------------->"
                     * +CNestMktData.sRecordBuffer); System.out.println(
                     * "CNestMktData.dTotalBuyQuantity------------------>"
                     * +CNestMktData.dTotalBuyQuantity); System.out.println(
                     * "CNestMktData.dTotalSellQuantity----------------->"
                     * +CNestMktData.dTotalSellQuantity); System.out.println(
                     * "CNestMktData.dTotalTradevalue------------------->"
                     * +CNestMktData.dTotalTradevalue); System.out.println(
                     * "CNestMktData.lClosingPrice---------------------->"
                     * +CNestMktData.lClosingPrice); System.out.println(
                     * "CNestMktData.lOpenPrice------------------------->"
                     * +CNestMktData.lOpenPrice); System.out.println(
                     * "CNestMktData.lHighPrice------------------------->"
                     * +CNestMktData.lHighPrice); System.out.println(
                     * "CNestMktData.lLowPrice-------------------------->"
                     * +CNestMktData.lLowPrice); System.out.println(
                     * "CNestMktData.lLowerCircuitLimit------------------>"
                     * +CNestMktData.lLowerCircuitLimit); System.out.println(
                     * "CNestMktData.lUpperCircuitLimit------------------>"
                     * +CNestMktData.lUpperCircuitLimit); System.out.println(
                     * "CNestMktData.sExchFeedTime----------------------->"
                     * +CNestMktData.sExchFeedTime); System.out.println(
                     * "CNestMktData.lSecondsSinceBoe-------------------->"
                     * +CNestMktData.lSecondsSinceBoe); System.out.println(
                     * "CNestMktData.lUsecs------------------------------>"
                     * +CNestMktData.lUsecs);
                     */
            ...
            case NESTconstants.NEST_INDEX_INFO:
                ...
                System.out.println(
                        "IndexInfo.iTransCode------->" + IndexInfo.iTransCode);
                System.out.println(
                        "IndexInfo.iValue----------->" + IndexInfo.iValue);
                System.out.println(
                        "IndexInfo.iOpenIndex------->" + IndexInfo.iOpenIndex);
                System.out.println(
                        "IndexInfo.iCloseIndex------>" + IndexInfo.iCloseIndex);

                /*
                 * System.out.println("IndexInfo.SIndexName------->"+IndexInfo.
                 * SIndexName);
                 * System.out.println("IndexInfo.SExchSeg--------->"
                 * +IndexInfo.SExchSeg);
                 * System.out.println("IndexInfo.SExchFeedTime---->"
                 * +IndexInfo.SExchFeedTime);
                 * System.out.println("IndexInfo.lSecondsSinceBoe->"
                 * +IndexInfo.lSecondsSinceBoe);
                 * System.out.println("IndexInfo.lUsecs----------->"
                 * +IndexInfo.lUsecs);
                 */
            ...
            default:
                System.out.println(
                        "Default NEST_Feed_constant---Not Matching with any case------------------->"
                                + NEST_FeedType_Constant);
            ...
            System.out.println(
                    "Exception in receiving packet: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public static CNESTBhavCopy NestBhavCpyConvert(byte[] ScripMaster) {
        ...
        try {
            ...
            cNestBhav.sExchSeg = NESTconvert.ByteToString(ScripMaster, iIndex,
                    10);

            cNestBhav.sSymbol = NESTconvert.ByteToString(ScripMaster,
                    iIndex + 10, 25);

            cNestBhav.lVolumeTradedToday = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 36);

            cNestBhav.lAverageTradePrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 40);

            cNestBhav.lNoofTrades = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 44);

            cNestBhav.dTotalTradevalue = NESTconvert.ByteToDouble(ScripMaster,
                    iIndex + 48);

            cNestBhav.lClosingPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 56);

            cNestBhav.lOpenPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 60);

            cNestBhav.lHighPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 64);

            cNestBhav.lLowPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 68);

            cNestBhav.lPrevClosingPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 72);

            cNestBhav.lYearlyLowPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 76);

            cNestBhav.lYearlyHighPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 80);

            cNestBhav.lHighestOpenInterest = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 84);

            cNestBhav.lLowestOpenInterest = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 88);

            cNestBhav.sExchFeedTime = NESTconvert.ByteToString(ScripMaster,
                    iIndex + 92, 25);

            cNestBhav.lSecondsSinceBoe = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 120);

            cNestBhav.lUsecs = NESTconvert.ByteToLong(ScripMaster, iIndex + 124);

            cNestBhav.lOpenInterest = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 128);
    ...
    public static CNESTMktPiccb NestMktPiccbConvert(byte[] ScripMaster) {
        ...
        try {
            ...
            NestMktPiccb.sExchSeg = NESTconvert.ByteToString(ScripMaster, iIndex,
                    10);

            NestMktPiccb.sSymbol = NESTconvert.ByteToString(ScripMaster,
                    iIndex + 10, 25);

            NestMktPiccb.siMarketType = NESTconvert.ByteToShort(ScripMaster,
                    iIndex + 36);

            NestMktPiccb.lVolumeTradedToday = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 40);

            NestMktPiccb.lLastTradedPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 44);

            NestMktPiccb.sNetChangeIndicator = NESTconvert.ByteToString(
                    ScripMaster, iIndex + 48, 1);

            NestMktPiccb.lNetPriceChangeFromClosingPrice = NESTconvert.ByteToLong(
                    ScripMaster, iIndex + 52);

            NestMktPiccb.lLastTradeQuantity = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 56);

            NestMktPiccb.lLastTradeTime = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 60);

            NestMktPiccb.lAverageTradePrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 64);

            NestMktPiccb.lNoofTrades = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 68);

            NestMktPiccb.siAuctionNumber = NESTconvert.ByteToShort(ScripMaster,
                    iIndex + 72);

            Vector<CNESTMBPInfo> ombpinfo = new Vector<CNESTMBPInfo>();

            for (int i = 0; i < 10; i++) {
                mbpinfo = new CNESTMBPInfo();
                mbpinfo = ProcessOutMBPInfo(ScripMaster,
                        (iIndex + (i * 12) + 74));

                /*
                 * System.out.println("-------------------MBPInfo--"+i+
                 * "------------------");
                 * System.out.println("mbpinfo.lquantity------------>"
                 * +mbpinfo.lQuantity);
                 * System.out.println("mbpinfo.lPrice--------------->"
                 * +mbpinfo.lPrice);
                 * System.out.println("mbpinfo.siNumberOfOrders----->"
                 * +mbpinfo.siNumberOfOrders);
                 * System.out.println("mbpinfo.siBbBuySellFlag------>"
                 * +mbpinfo.siBbBuySellFlag); System.out.println(
                 * "-----------------------------------------------");
                 */
            ...
            NestMktPiccb.sRecordBuffer = ombpinfo;
            NestMktPiccb.dTotalBuyQuantity = NESTconvert.ByteToDouble(
                    ScripMaster, iIndex + 196);
            NestMktPiccb.dTotalSellQuantity = NESTconvert.ByteToDouble(
                    ScripMaster, iIndex + 204);
            NestMktPiccb.dTotalTradevalue = NESTconvert.ByteToDouble(ScripMaster,
                    iIndex + 212);
            NestMktPiccb.lClosingPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 220);
            NestMktPiccb.lOpenPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 224);
            NestMktPiccb.lHighPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 228);
            NestMktPiccb.lLowPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 232);

            NestMktPiccb.lYearlyLowPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 236);
            NestMktPiccb.lYearlyHighPrice = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 240);

            NestMktPiccb.lLowerCircuitLimit = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 244);
            NestMktPiccb.lUpperCircuitLimit = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 248);
            NestMktPiccb.sExchFeedTime = NESTconvert.ByteToString(ScripMaster,
                    iIndex + 252, 25);
            NestMktPiccb.lSecondsSinceBoe = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 280);
            NestMktPiccb.lUsecs = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 284);
            NestMktPiccb.lOpenIntereset = NESTconvert.ByteToLong(ScripMaster,
                    iIndex + 288);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static CNESTMBPInfo ProcessOutMBPInfo(byte[] MBPbytes, int index) {
        ...
        try {
            ...
            MBPinformation.siNumberOfOrders = NESTconvert.ByteToShort(MBPbytes,
                    index + 8);
            MBPinformation.siBbBuySellFlag = NESTconvert.ByteToShort(MBPbytes,
                    index + 10);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static CNESTDJNews NestDJNewsInfoConvert(byte[] NewsBytes) {
        ...
        try {
            ...
            // System.out.println("------------------------------------------------------------------------------");
            System.out.println(
                    "DJ_News_Info.iTransCode----->" + DJ_News_Info.iTransCode);

            DJ_News_Info.sNewsMessagetype = NESTconvert.ByteToString(NewsBytes,
                    4, 1);
            ...
            DJ_News_Info.sNewshotindicator = NESTconvert.ByteToString(NewsBytes,
                    30, 1);
            // System.out.println("DJ_News_Info.sNewshotindicator--------->"+DJ_News_Info.sNewshotindicator);
            DJ_News_Info.iAccessionnumber = NESTconvert.ByteToLongLong(NewsBytes,
                    32);
            ...
            DJ_News_Info.iExpirymessagecount = NESTconvert.ByteToInt(NewsBytes,
                    48);
            // System.out.println("DJ_News_Info.iExpirymessagecount--------->"+DJ_News_Info.iExpirymessagecount);
            DJ_News_Info.sExpirymessagelist = NESTconvert.ByteToString(NewsBytes,
                    52, 20);
            ...
            String sNews_tag = NESTconvert.ByteToString(NewsBytes, 92,
                    DJ_News_Info.iNewsTagLength);
            ...
            try {
                ...
                String News_Headlines = NESTconvert.ByteToString(NewsBytes,
                        92 + DJ_News_Info.iNewsTagLength,
                        DJ_News_Info.inewslength);
                ...
                String News_Headlines1 = NESTconvert.ByteToString(NewsBytes,
                        92 + DJ_News_Info.iNewsTagLength,
                        (BUFFER_SIZE - (92 + DJ_News_Info.iNewsTagLength)));
            ...
            // System.out.println("------------------------------------------------------------------------------");
            /*
             * System.out.println("DJ_News_Info.iTransCode----->"+DJ_News_Info.
             * iTransCode);
             * System.out.println("DJ_News_Info.sSource--------->"+DJ_News_Info
             * .sSource);
             * System.out.println("DJ_News_Info.sNewshotindicator--------->"
             * +DJ_News_Info.sNewshotindicator);
             * System.out.println("DJ_News_Info.iAccessionnumber--------->"
             * +DJ_News_Info.iAccessionnumber);
             * System.out.println("DJ_News_Info.iGmtdate --------->"
             * +DJ_News_Info.iGmtdate );
             * System.out.println("DJ_News_Info.iGMTtime--------->"
             * +DJ_News_Info.iGMTtime);
             * System.out.println("DJ_News_Info.iExpirymessagecount--------->"
             * +DJ_News_Info.iExpirymessagecount);
             * System.out.println("DJ_News_Info.sExpirymessagelist--------->"
             * +DJ_News_Info.sExpirymessagelist);
             * System.out.println("DJ_News_Info.sActioncode --------->"
             * +DJ_News_Info.sActioncode );
             * System.out.println("DJ_News_Info.iRefSeqNumber--------->"
             * +DJ_News_Info.iRefSeqNumber);
             * System.out.println("DJ_News_Info.sNewstag  --------->"
             * +DJ_News_Info.sNewstag );
             * System.out.println("DJ_News_Info.iNewsSeqNumber --------->"
             * +DJ_News_Info.iNewsSeqNumber );
             * System.out.println("DJ_News_Info.inewslength--------->"
             * +DJ_News_Info.inewslength);
             * System.out.println("DJ_News_Info.sNewsheadlineStory--------->"
             * +DJ_News_Info.sNewsheadlineStory);
             */
    ...
    public static CNESTIndexInfo NestIndexInfoConvert(byte[] IndexBytes) {
        ...
        try {
            ...
            Ind_Info.SExchFeedTime = NESTconvert.ByteToString(IndexBytes, 126,
                    25);
    ...
    public static boolean ReadFileNSE(ResourceBundle oResourceBundle,
            String s_FilePath) {

        try {
            BufferedReader in = new BufferedReader(
                    new FileReader(s_FilePath.trim() + "NSE_EQ_INPUT.txt"));
            ...
            System.out.println(
                    "Error :: ==> Error file (NSE_EQ_INPUT.txt) not found :: ==>"
                            + e);
            return false;
        }
    ...
    public static boolean ReadFileNFO(ResourceBundle oResourceBundle,
            String s_FilePath) {

        try {
            BufferedReader in = new BufferedReader(
                    new FileReader(s_FilePath.trim() + "NSE_FO_INPUT.txt"));
            ...
            System.out.println(
                    " Error :: ==> Error file (NSE_FO_INPUT.txt) not found :: ==>"
                            + e);
            return false;
        }
    ...
    public static boolean ReadFileBSE(ResourceBundle oResourceBundle,
            String s_FilePath) {

        try {

            BufferedReader in = new BufferedReader(
                    new FileReader(s_FilePath.trim() + "BSE_EQ_INPUT.txt"));
    ...
    public static boolean ReadFileMCX(ResourceBundle oResourceBundle,
            String s_FilePath) {

        try {
            BufferedReader in = new BufferedReader(
                    new FileReader(s_FilePath.trim() + "MCX_INPUT.txt"));
            ...
            System.out.println(
                    " Error :: ==> Error file (MCX_INPUT.txt) not found :: ==>"
                            + e);
            return false;
        }
    } // end of reading NSE_FO_INPUT.txt and adding it to vector vec_mcx

    public static boolean ReadFileNCDEX(ResourceBundle oResourceBundle,
            String s_FilePath) {

        try {
            BufferedReader in = new BufferedReader(
                    new FileReader(s_FilePath.trim() + "NCDEX_INPUT.txt"));
            ...
            System.out.println(
                    " Error :: ==> Error file (NCDEX_INPUT.txt) not found :: ==>"
                            + e);
            return false;
        }
    } // end of reading NSE_FO_INPUT.txt and adding it to vector vec_nse_cm

    public static boolean ReadFileCDS(ResourceBundle oResourceBundle,
            String s_FilePath) {

        try {
            BufferedReader in = new BufferedReader(
                    new FileReader(s_FilePath.trim() + "CDS_INPUT.txt"));
            ...
            System.out.println(
                    " Error :: ==> Error file (CDS_INPUT.txt) not found :: ==>"
                            + e);
            return false;
        }
    } // end of reading NSE_FO_INPUT.txt and adding it to vector vec_nse_cm
    ...
    public static void SubscribeforDJNews(ResourceBundle oRes) {
        ...
        try {
            ...
            oReqNameDj.sPortfolio = oRes.getString("NEST_SCRIP_CODE").trim();
            oReqNameDj.sNewsTag = oRes.getString("NEST_DJ_NEWS_TAG").trim();

            if (oReqNameDj.sPortfolio.trim().equals("")
                    && oReqNameDj.sNewsTag.trim().equals("")) {
                oReqNameDj.iReqType = 482;
            } else if (!oReqNameDj.sPortfolio.trim().equals("")
                    && oReqNameDj.sNewsTag.trim().equals("")) {
            ...
            System.out.println(
                    "oReqNameDj.sPortfolio - - - - -" + oReqNameDj.sPortfolio);
            System.out.println(
                    "oReqNameDj.sNewsTag   - - - - -" + oReqNameDj.sNewsTag);
            System.out.println(
                    "oReqNameDj.iReqType   - - - - -" + oReqNameDj.iReqType);
            ...
            System.out.println(
                    "Error :: Exception in sentRequestToServerSubscribe ===>"
                            + e);
        }
     ...
     * 
     * 
     * public static void UnSubScribe(String exc, String sToken) { int iReq try
     * { CServerRequest oReqNamense = new CServerRequest();
     * oReqNamense.sExchange = s_Exchange; oReqNamense.iReqType = i_RequestId;
     * oReqNamense.oAccountId = s_UserName; oReqNamense.iDDInteractive = 1;
     * 
     * //System.out.println("s_Exchange" +s_Exchange); for(int i=0;
     * i<v_token_vect.size(); i++) { //System.out.println(v_token_vect.get(i));
     * oReqNamense.v_symbol.add(v_token_vect.get(i)); }
     * 
     * 
     * try { out_stream.writeObject(oReqNamense); out_stream.flush(); } catch
     * (IOException e) {
     * 
     * e.printStackTrace(); }
     * 
     * } catch(Exception exx) {
     * System.out.println("Error :: Exception in sentRequestToServerSubscribe ===>"
     * +exx); } }
     */
    ...
    public static void sentRequestToServerSubscribe(int i_RequestId,
            String s_Exchange, Vector<String> v_token_vect) {
        try {
            CServerRequest oReqNamense = new CServerRequest();
    ...
    public static void sentRequestToServerUnSubscribe(int i_RequestId,
            String s_Exchange, Vector<?> v_token_vect) {
        try {
            CServerRequest oReqNamense = new CServerRequest();
